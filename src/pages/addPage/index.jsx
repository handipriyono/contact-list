...
const Details = () => {
  const { firstName, lastName, age, onChange, addContactAPIItem } =
  ...
  return (
    <>
      <Layout>
        ...
        <div className="flex flex-row pb-2 border-solid border-b border-[#e1e3e2] p-2 sm:p-5 align-middle items-center content-center gap-2 sm:gap-5"></div>

        <div className="flex flex-col justify-center mb-5 mt-5">
          <h1 className="text-black text-2xl">Create Contact</h1>
        </div>
